...
Responsibilities:
- accept a list of PlotConfig objects or raw plot payloads from processors
- validate and normalize plot configuration objects
...
class PlottingService:
    ...
    This service:
        - validates plot payloads
        - normalizes raw dicts into PlotConfig
