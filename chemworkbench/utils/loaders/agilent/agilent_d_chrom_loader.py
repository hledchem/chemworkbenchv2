...
class AgilentDChromLoader(BaseVendorLoader):
    ...
    def load_raw(self, path: Path) -> Any:
        try:
            ...
            if not chrom_files:
                raise LoaderReadError(f"No chromatogram files found in Agilent .D directory '{path}'")
            ...
            raise LoaderReadError(f"Failed to read Agilent .D chromatogram directory '{path}': {exc}") from exc
    ...
    def extract_metadata(self, raw_data: Any) -> Mapping[str, Any]:
        try:
            ...
            raise LoaderMetadataError(f"Failed to extract metadata from Agilent .D chromatograms: {exc}") from exc
    ...
    def to_universal(self, raw_data: Any, metadata: Mapping[str, Any]) -> Any:
        try:
            ...
            raise LoaderNormalizationError(f"Failed to normalize Agilent .D chromatogram data: {exc}") from exc
